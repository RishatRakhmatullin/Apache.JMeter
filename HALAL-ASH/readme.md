...
Поэтому, при рандомном выборе "icon14", заменяем "icon14" ( "2-00. JSR223 PostProcessor. Выбор id_catalog") на подобный каталог "icon5" - "<b>Мясные деликатесы</b>" у которого "35" наменований .</p>
