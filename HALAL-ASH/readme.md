...
Поэтому, при рандомном выборе "icon14", заменяем его на подобный каталог "icon5" - "Мясные деликатесы" у которого "35" наменований ( "2-00. JSR223 PostProcessor. Выбор id_catalog").</p>
